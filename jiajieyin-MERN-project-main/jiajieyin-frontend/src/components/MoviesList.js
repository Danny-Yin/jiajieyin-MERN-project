...
const MoviesList = ({
    ...
    // set Page to 0 when currentSearchMode changes
    useEffect(() => {
        setCurrentPage(0);
    }, [currentSearchMode]);
    ...
    // These two functions are triggered by form control events.When the value of the search fields title or rating changes, these functions will be called.
